 ...
 * property source used to turn the arguments into configuration properties. <p/> Main classes
 * should use this class as follows: <code>
 * ```
...
class AirbyteConnectorRunner {
    companion object {
        fun <R : Runnable?> run(
            ...
            builder.start().use { ctx -> run(cls, ctx, *args) }
        }
