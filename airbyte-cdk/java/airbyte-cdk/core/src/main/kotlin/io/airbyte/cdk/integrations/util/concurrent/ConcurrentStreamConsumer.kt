...
class ConcurrentStreamConsumer(
    ...
    /**
     * Returns the parallelism value that will be used by this consumer to execute the consumption
     * of data from the provided streams in parallel.
     *
    ...
    private class ConcurrentStreamRunnable(
        ...
        consumer: ConcurrentStreamConsumer
    ) : Runnable {
        override fun run() {
